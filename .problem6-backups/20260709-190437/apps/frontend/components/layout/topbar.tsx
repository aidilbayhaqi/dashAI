    ...
    <header className="sticky top-0 z-30 px-6 pt-5 lg:px-8">
      <div className="flex h-16 items-center justify-between rounded-[1.5rem] border border-slate-200/80 bg-white/80 px-5 shadow-sm backdrop-blur-2xl dark:border-slate-800/80 dark:bg-slate-950/75">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-600 shadow-sm transition hover:-translate-y-0.5 hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300 dark:hover:bg-slate-900">
            <Bell size={18} />
          </button>
          ...
          <button
            ...
            className="inline-flex h-10 items-center gap-2 rounded-2xl bg-slate-950 px-4 text-sm font-bold text-white shadow-lg shadow-slate-900/10 transition hover:-translate-y-0.5 hover:bg-slate-800 dark:bg-white dark:text-slate-950 dark:hover:bg-slate-200"
          >
            <LogOut size={16} />
            Logout
          </button>
