...
export const financeModuleConfig: Record<FinanceModuleKey, ModuleConfig> = {
  ...
  { key: "beginning_cash_balance_display", label: "Beginning Cash" },
  { key: "operating_cash_in_display", label: "Operating In" },
  { key: "operating_cash_out_display", label: "Operating Out" },
  { key: "investing_cash_in_display", label: "Investing In" },
  { key: "investing_cash_out_display", label: "Investing Out" },
  { key: "financing_cash_in_display", label: "Financing In" },
  { key: "financing_cash_out_display", label: "Financing Out" },
  { key: "net_cashflow_display", label: "Net Cashflow" },
  { key: "ending_cash_balance_display", label: "Ending Cash" },
],
  ...
  taxes: {
    ...
    columns: [
      ...
      { key: "tax_amount_display", label: "Tax Amount" },
      { key: "paid_amount_display", label: "Paid" },
      { key: "due_date_display", label: "Due Date" },
      { key: "status_label", label: "Status" },
    ],
  ...
  ledger: {
    ...
    columns: [
      ...
      { key: "total_debit_display", label: "Debit" },
      { key: "total_credit_display", label: "Credit" },
